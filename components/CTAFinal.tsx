...
export default function CTAFinal() {
  return (
    <section
      id="cta-final"
      style={{ backgroundColor: "#c8622a", padding: "6rem 1.5rem" }}
    >
      <div className="max-w-4xl mx-auto text-center">
        <span className="inline-block mb-6 font-mono text-xs uppercase tracking-widest" style={{ color: "rgba(240,236,226,0.6)" }}>
          Passez à l&apos;action
        </span>
        ...
        >
          ...
          <em style={{ fontStyle: "italic" }}>maîtriser</em>
          <br />
        ...
        <p
          ...
          style={{ fontSize: "1.05rem", color: "rgba(240,236,226,0.75)", fontWeight: 300 }}
        >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            style={{ backgroundColor: "#f0ece2", color: "#1a1a18", border: "1px solid #f0ece2" }}
            onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.backgroundColor = "#fff")}
            onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.backgroundColor = "#f0ece2")}
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-sm font-sans text-base font-medium transition-all duration-300"
            style={{ backgroundColor: "transparent", color: "#f0ece2", border: "1px solid rgba(240,236,226,0.4)" }}
            onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.borderColor = "rgba(240,236,226,0.8)")}
            onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.borderColor = "rgba(240,236,226,0.4)")}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <p className="mt-8 font-sans text-xs" style={{ color: "rgba(240,236,226,0.45)" }}>
